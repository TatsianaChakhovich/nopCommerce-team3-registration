  ...
  Feature: Registration
    ...
    Scenario Outline: Verify that user is able to register to the application
      ...
      Examples:
        ...
        | "male"   | "Ivan"    | "Ivanov" | 20  | "June"     | 1985 | "ivanov955@gmail.com"   | "Apple"     | "123456"   | "123456"     |
        | "female" | "Hanna"   | "Smith"  | 1   | "January"  | 2001 | "hs-24745955@yahoo.com" | "Td&55"     | "Gg56*$@!" | "Gg56*$@!"   |
    ...
    Scenario: Verify that user is not able to register twice using the same email
      ...
      When I enter "ivanov955@gmail.com" into Email field
